...
"ortho-distinguer-a-a": {
  ...
  level1Bank: [
    { type:"choix-etiquette", instruction:"Quel mot complète la phrase : « a » ou « à » ?", word:"Il ___ mangé toute la tarte.", choices:["a","à"], answer:"a" },
    { type:"choix-etiquette", instruction:"Quel mot complète la phrase : « a » ou « à » ?", word:"Elle pense ___ ses amis.", choices:["a","à"], answer:"à" },
    { type:"choix-etiquette", instruction:"Quel mot complète la phrase : « a » ou « à » ?", word:"Le chat ___ renversé son bol.", choices:["a","à"], answer:"a" },
    { type:"choix-etiquette", instruction:"Quel mot complète la phrase : « a » ou « à » ?", word:"Nous allons ___ la piscine.", choices:["a","à"], answer:"à" },
    { type:"choix-etiquette", instruction:"Quel mot complète la phrase : « a » ou « à » ?", word:"Papa ___ appelé le médecin.", choices:["a","à"], answer:"a" },
    { type:"choix-etiquette", instruction:"Quel mot complète la phrase : « a » ou « à » ?", word:"Il tient ___ son jouet.", choices:["a","à"], answer:"à" },
    { type:"choix-etiquette", instruction:"Quel mot complète la phrase : « a » ou « à » ?", word:"Elle ___ oublié son cartable.", choices:["a","à"], answer:"a" },
    { type:"choix-etiquette", instruction:"Quel mot complète la phrase : « a » ou « à » ?", word:"Le train part ___ midi.", choices:["a","à"], answer:"à" },
    { type:"choix-etiquette", instruction:"Quel mot complète la phrase : « a » ou « à » ?", word:"Mon frère ___ couru très vite.", choices:["a","à"], answer:"a" },
    { type:"choix-etiquette", instruction:"Quel mot complète la phrase : « a » ou « à » ?", word:"Ce livre appartient ___ Léa.", choices:["a","à"], answer:"à" },
    { type:"choix-etiquette", instruction:"Quel mot complète la phrase : « a » ou « à » ?", word:"Il ___ neigé cette nuit.", choices:["a","à"], answer:"a" },
    { type:"choix-etiquette", instruction:"Quel mot complète la phrase : « a » ou « à » ?", word:"Je pense ___ toi.", choices:["a","à"], answer:"à" }
  ],
...
"ortho-distinguer-ce-se": {
  ...
  level1Bank: [
    { type:"choix-etiquette", instruction:"Quel mot complète la phrase : « ce » ou « se » ?", word:"Il ___ lave les mains avant de manger.", choices:["ce","se"], answer:"se" },
    { type:"choix-etiquette", instruction:"Quel mot complète la phrase : « ce » ou « se » ?", word:"___ film est très drôle.", choices:["ce","se"], answer:"ce" },
    { type:"choix-etiquette", instruction:"Quel mot complète la phrase : « ce » ou « se » ?", word:"Elle ___ dépêche pour ne pas être en retard.", choices:["ce","se"], answer:"se" },
    { type:"choix-etiquette", instruction:"Quel mot complète la phrase : « ce » ou « se » ?", word:"Il aime ___ quartier depuis toujours.", choices:["ce","se"], answer:"ce" },
    { type:"choix-etiquette", instruction:"Quel mot complète la phrase : « ce » ou « se » ?", word:"Le chat ___ cache sous le canapé.", choices:["ce","se"], answer:"se" },
    { type:"choix-etiquette", instruction:"Quel mot complète la phrase : « ce » ou « se » ?", word:"___ que tu dis est intéressant.", choices:["ce","se"], answer:"ce" },
    { type:"choix-etiquette", instruction:"Quel mot complète la phrase : « ce » ou « se » ?", word:"Il ___ souvient de ses vacances.", choices:["ce","se"], answer:"se" },
    { type:"choix-etiquette", instruction:"Quel mot complète la phrase : « ce » ou « se » ?", word:"Regarde ___ beau coucher de soleil.", choices:["ce","se"], answer:"ce" },
    { type:"choix-etiquette", instruction:"Quel mot complète la phrase : « ce » ou « se » ?", word:"Elle ___ repose après le sport.", choices:["ce","se"], answer:"se" },
    { type:"choix-etiquette", instruction:"Quel mot complète la phrase : « ce » ou « se » ?", word:"___ soir, on mange ensemble.", choices:["ce","se"], answer:"ce" },
    { type:"choix-etiquette", instruction:"Quel mot complète la phrase : « ce » ou « se » ?", word:"Le bébé ___ réveille souvent la nuit.", choices:["ce","se"], answer:"se" },
    { type:"choix-etiquette", instruction:"Quel mot complète la phrase : « ce » ou « se » ?", word:"Il ne comprend pas ___ qui s'est passé.", choices:["ce","se"], answer:"ce" }
  ],
  ...
  "ortho-distinguer-ces-ses-cest-sest": {
    ...
    level1Bank: [
      { type:"choix-etiquette", instruction:"Quel mot complète la phrase : « ces » ou « ses » ?", word:"Il brosse ___ dents avant de se coucher.",        choices:["ces","ses"], answer:"ses" },
      { type:"choix-etiquette", instruction:"Quel mot complète la phrase : « ces » ou « ses » ?", word:"Regarde ___ beaux papillons là-bas !",           choices:["ces","ses"], answer:"ces" },
      { type:"choix-etiquette", instruction:"Quel mot complète la phrase : « ces » ou « ses » ?", word:"Elle peigne ___ cheveux devant le miroir.",      choices:["ces","ses"], answer:"ses" },
      { type:"choix-etiquette", instruction:"Quel mot complète la phrase : « ces » ou « ses » ?", word:"___ étoiles brillent très fort ce soir.",        choices:["ces","ses"], answer:"ces" },
      { type:"choix-etiquette", instruction:"Quel mot complète la phrase : « ces » ou « ses » ?", word:"Le chat lèche ___ pattes après avoir mangé.",    choices:["ces","ses"], answer:"ses" },
      { type:"choix-etiquette", instruction:"Quel mot complète la phrase : « ces » ou « ses » ?", word:"___ vagues sont très dangereuses aujourd'hui.",  choices:["ces","ses"], answer:"ces" },
      { type:"choix-etiquette", instruction:"Quel mot complète la phrase : « ces » ou « ses » ?", word:"Il emporte toujours ___ médicaments en voyage.", choices:["ces","ses"], answer:"ses" },
      { type:"choix-etiquette", instruction:"Quel mot complète la phrase : « ces » ou « ses » ?", word:"___ fleurs sauvages poussent le long du chemin.", choices:["ces","ses"], answer:"ces" },
      { type:"choix-etiquette", instruction:"Quel mot complète la phrase : « ces » ou « ses » ?", word:"Elle écrit ___ secrets dans un journal intime.",  choices:["ces","ses"], answer:"ses" },
      { type:"choix-etiquette", instruction:"Quel mot complète la phrase : « ces » ou « ses » ?", word:"On peut voir ___ sommets enneigés depuis ici.",  choices:["ces","ses"], answer:"ces" },
      { type:"choix-etiquette", instruction:"Quel mot complète la phrase : « ces » ou « ses » ?", word:"Il téléphone souvent à ___ grands-parents.",     choices:["ces","ses"], answer:"ses" },
      { type:"choix-etiquette", instruction:"Quel mot complète la phrase : « ces » ou « ses » ?", word:"___ petits oiseaux reviennent chaque printemps.", choices:["ces","ses"], answer:"ces" }
    ],

    level2Bank: [
      { type:"choix-etiquette", instruction:"Quel mot complète la phrase : « c'est » ou « s'est » ?", word:"___ une belle journée.",             choices:["c'est","s'est"], answer:"c'est" },
      { type:"choix-etiquette", instruction:"Quel mot complète la phrase : « c'est » ou « s'est » ?", word:"Il ___ trompé de chemin.",           choices:["c'est","s'est"], answer:"s'est" },
      { type:"choix-etiquette", instruction:"Quel mot complète la phrase : « c'est » ou « s'est » ?", word:"___ lui qui a gagné.",                choices:["c'est","s'est"], answer:"c'est" },
      { type:"choix-etiquette", instruction:"Quel mot complète la phrase : « c'est » ou « s'est » ?", word:"Elle ___ blessée en tombant.",       choices:["c'est","s'est"], answer:"s'est" },
      { type:"choix-etiquette", instruction:"Quel mot complète la phrase : « c'est » ou « s'est » ?", word:"___ vrai ce que tu dis.",             choices:["c'est","s'est"], answer:"c'est" },
      { type:"choix-etiquette", instruction:"Quel mot complète la phrase : « c'est » ou « s'est » ?", word:"Le chat ___ caché sous le lit.",     choices:["c'est","s'est"], answer:"s'est" },
      { type:"choix-etiquette", instruction:"Quel mot complète la phrase : « c'est » ou « s'est » ?", word:"___ difficile à comprendre.",         choices:["c'est","s'est"], answer:"c'est" },
      { type:"choix-etiquette", instruction:"Quel mot complète la phrase : « c'est » ou « s'est » ?", word:"Il ___ endormi pendant le film.",    choices:["c'est","s'est"], answer:"s'est" },
      { type:"choix-etiquette", instruction:"Quel mot complète la phrase : « c'est » ou « s'est » ?", word:"___ ici que tout a commencé.",        choices:["c'est","s'est"], answer:"c'est" },
      { type:"choix-etiquette", instruction:"Quel mot complète la phrase : « c'est » ou « s'est » ?", word:"Elle ___ souvenue de son rêve.",     choices:["c'est","s'est"], answer:"s'est" },
      { type:"choix-etiquette", instruction:"Quel mot complète la phrase : « c'est » ou « s'est » ?", word:"___ pour ça qu'il est parti.",        choices:["c'est","s'est"], answer:"c'est" },
      { type:"choix-etiquette", instruction:"Quel mot complète la phrase : « c'est » ou « s'est » ?", word:"Le soleil ___ levé très tôt.",       choices:["c'est","s'est"], answer:"s'est" }
    ],
    ...
    level3Bank: [
      { type:"choix-etiquette", instruction:"Quel mot complète la phrase ?", word:"Je ___ que tu as raison.",                 choices:["sais","sait"],   answer:"sais"   },
      { type:"choix-etiquette", instruction:"Quel mot complète la phrase ?", word:"___ incroyable ce qu'il a fait !",         choices:["c'est","s'est"], answer:"c'est"  },
      { type:"choix-etiquette", instruction:"Quel mot complète la phrase ?", word:"Il ___ très bien jouer de la guitare.",     choices:["sais","sait"],   answer:"sait"   },
      { type:"choix-etiquette", instruction:"Quel mot complète la phrase ?", word:"Elle ___ levée tôt pour prendre le train.", choices:["c'est","s'est"], answer:"s'est"  },
      { type:"choix-etiquette", instruction:"Quel mot complète la phrase ?", word:"___ montagnes sont couvertes de neige en hiver.", choices:["ces","ses"], answer:"ces" },
      { type:"choix-etiquette", instruction:"Quel mot complète la phrase ?", word:"Tu ___ ce que tu fais ?",                   choices:["sais","sait"],   answer:"sais"   },
      { type:"choix-etiquette", instruction:"Quel mot complète la phrase ?", word:"___ grâce à elle que tout s'est arrangé.",  choices:["c'est","s'est"], answer:"c'est"  },
      { type:"choix-etiquette", instruction:"Quel mot complète la phrase ?", word:"Il ___ perdu dans la forêt.",              choices:["c'est","s'est"], answer:"s'est"  },
      { type:"choix-etiquette", instruction:"Quel mot complète la phrase ?", word:"___ vagues fascinent les surfeurs.",       choices:["ces","ses"],     answer:"ces"    },
      { type:"choix-etiquette", instruction:"Quel mot complète la phrase ?", word:"Le chien agite ___ pattes de joie.",       choices:["ces","ses"],     answer:"ses"    },
      { type:"choix-etiquette", instruction:"Quel mot complète la phrase ?", word:"On ne ___ jamais de quoi demain sera fait.", choices:["sais","sait"], answer:"sait"   },
      { type:"choix-etiquette", instruction:"Quel mot complète la phrase ?", word:"Il ___ souvenu de cet épisode.",           choices:["c'est","s'est"], answer:"s'est" },
      { type:"choix-etiquette", instruction:"Quel mot complète la phrase ?", word:"Il sait ce qui ___ passé.",                choices:["c'est","s'est"], answer:"s'est" },
  ...
  "ortho-distinguer-et-est": {
    ...
    level1Bank: [
      { type:"choix-etiquette", instruction:"Quel mot complète la phrase : « est » ou « et » ?", word:"Le ciel ___ bleu aujourd'hui.",            choices:["est","et"], answer:"est" },
      { type:"choix-etiquette", instruction:"Quel mot complète la phrase : « est » ou « et » ?", word:"Il mange une pomme ___ une poire.",         choices:["est","et"], answer:"et"  },
      { type:"choix-etiquette", instruction:"Quel mot complète la phrase : « est » ou « et » ?", word:"La maîtresse ___ absente ce matin.",        choices:["est","et"], answer:"est" },
      { type:"choix-etiquette", instruction:"Quel mot complète la phrase : « est » ou « et » ?", word:"Elle prend son manteau ___ ses gants.",     choices:["est","et"], answer:"et"  },
      { type:"choix-etiquette", instruction:"Quel mot complète la phrase : « est » ou « et » ?", word:"Le chien ___ fatigué après sa promenade.",  choices:["est","et"], answer:"est" },
      { type:"choix-etiquette", instruction:"Quel mot complète la phrase : « est » ou « et » ?", word:"Papa lit le journal ___ boit son café.",    choices:["est","et"], answer:"et"  },
      { type:"choix-etiquette", instruction:"Quel mot complète la phrase : « est » ou « et » ?", word:"La porte ___ fermée à clé.",                choices:["est","et"], answer:"est" },
      { type:"choix-etiquette", instruction:"Quel mot complète la phrase : « est » ou « et » ?", word:"Il aime le foot ___ le vélo.",              choices:["est","et"], answer:"et"  },
      { type:"choix-etiquette", instruction:"Quel mot complète la phrase : « est » ou « et » ?", word:"Le repas ___ prêt.",                        choices:["est","et"], answer:"est" },
      { type:"choix-etiquette", instruction:"Quel mot complète la phrase : « est » ou « et » ?", word:"Lucie chante ___ danse très bien.",         choices:["est","et"], answer:"et"  },
      { type:"choix-etiquette", instruction:"Quel mot complète la phrase : « est » ou « et » ?", word:"Ce livre ___ très intéressant.",            choices:["est","et"], answer:"est" },
      { type:"choix-etiquette", instruction:"Quel mot complète la phrase : « est » ou « et » ?", word:"Il range ses affaires ___ part à l'école.", choices:["est","et"], answer:"et"  }
    ],
...
"ortho-distinguer-leur-leurs": {
  ...
  level1Bank: [
    { type:"choix-etiquette", instruction:"Quel mot complète la phrase : « leur » ou « leurs » ?", word:"Les enfants rangent ___ affaires.",    choices:["leur","leurs"], answer:"leurs" },
    { type:"choix-etiquette", instruction:"Quel mot complète la phrase : « leur » ou « leurs » ?", word:"Les élèves ont rendu ___ copie.",      choices:["leur","leurs"], answer:"leur"  },
    { type:"choix-etiquette", instruction:"Quel mot complète la phrase : « leur » ou « leurs » ?", word:"Les chats lèchent ___ pelage.",        choices:["leur","leurs"], answer:"leur"  },
    { type:"choix-etiquette", instruction:"Quel mot complète la phrase : « leur » ou « leurs » ?", word:"Les joueurs enfilent ___ maillots.",   choices:["leur","leurs"], answer:"leurs" },
    { type:"choix-etiquette", instruction:"Quel mot complète la phrase : « leur » ou « leurs » ?", word:"Les parents attendent ___ enfants.",   choices:["leur","leurs"], answer:"leurs" },
    { type:"choix-etiquette", instruction:"Quel mot complète la phrase : « leur » ou « leurs » ?", word:"Les oiseaux regagnent ___ nid.",       choices:["leur","leurs"], answer:"leur"  },
    { type:"choix-etiquette", instruction:"Quel mot complète la phrase : « leur » ou « leurs » ?", word:"Les élèves ouvrent ___ cahiers.",      choices:["leur","leurs"], answer:"leurs" },
    { type:"choix-etiquette", instruction:"Quel mot complète la phrase : « leur » ou « leurs » ?", word:"Les pompiers font ___ travail.",       choices:["leur","leurs"], answer:"leur"  },
    { type:"choix-etiquette", instruction:"Quel mot complète la phrase : « leur » ou « leurs » ?", word:"Les enfants lavent ___ mains.",        choices:["leur","leurs"], answer:"leurs" },
    { type:"choix-etiquette", instruction:"Quel mot complète la phrase : « leur » ou « leurs » ?", word:"Les coureurs reprennent ___ souffle.", choices:["leur","leurs"], answer:"leur"  },
    { type:"choix-etiquette", instruction:"Quel mot complète la phrase : « leur » ou « leurs » ?", word:"Les touristes prennent ___ photos.",   choices:["leur","leurs"], answer:"leurs" },
    { type:"choix-etiquette", instruction:"Quel mot complète la phrase : « leur » ou « leurs » ?", word:"Les acteurs apprennent ___ rôle.",     choices:["leur","leurs"], answer:"leur"  }
  ],
...
"ortho-distinguer-on-ont": {
  ...
  level1Bank: [
    { type:"choix-etiquette", instruction:"Quel mot complète la phrase : « on » ou « ont » ?", word:"Les élèves ___ fini leur travail.", choices:["on","ont"], answer:"ont" },
    { type:"choix-etiquette", instruction:"Quel mot complète la phrase : « on » ou « ont » ?", word:"___ entend les oiseaux chanter.", choices:["on","ont"], answer:"on" },
    { type:"choix-etiquette", instruction:"Quel mot complète la phrase : « on » ou « ont » ?", word:"Mes parents ___ acheté une voiture.", choices:["on","ont"], answer:"ont" },
    { type:"choix-etiquette", instruction:"Quel mot complète la phrase : « on » ou « ont » ?", word:"___ ne sait jamais ce qui peut arriver.", choices:["on","ont"], answer:"on" },
    { type:"choix-etiquette", instruction:"Quel mot complète la phrase : « on » ou « ont » ?", word:"Les enfants ___ joué toute la journée.", choices:["on","ont"], answer:"ont" },
    { type:"choix-etiquette", instruction:"Quel mot complète la phrase : « on » ou « ont » ?", word:"___ dirait qu'il va pleuvoir.", choices:["on","ont"], answer:"on" },
    { type:"choix-etiquette", instruction:"Quel mot complète la phrase : « on » ou « ont » ?", word:"Mes amis ___ organisé une fête.", choices:["on","ont"], answer:"ont" },
    { type:"choix-etiquette", instruction:"Quel mot complète la phrase : « on » ou « ont » ?", word:"___ peut voir la mer depuis ici.", choices:["on","ont"], answer:"on" },
    { type:"choix-etiquette", instruction:"Quel mot complète la phrase : « on » ou « ont » ?", word:"Les pompiers ___ éteint l'incendie.", choices:["on","ont"], answer:"ont" },
    { type:"choix-etiquette", instruction:"Quel mot complète la phrase : « on » ou « ont » ?", word:"___ a sonné à la porte.", choices:["on","ont"], answer:"on" },
    { type:"choix-etiquette", instruction:"Quel mot complète la phrase : « on » ou « ont » ?", word:"Les voisins ___ fait beaucoup de bruit.", choices:["on","ont"], answer:"ont" },
    { type:"choix-etiquette", instruction:"Quel mot complète la phrase : « on » ou « ont » ?", word:"___ apprend beaucoup de choses à l'école.", choices:["on","ont"], answer:"on" }
  ],
...
"ortho-distinguer-ou-ou": {
  ...
  level1Bank: [
    { type:"choix-etiquette", instruction:"Quel mot complète la phrase : « ou » ou « où » ?", word:"Tu veux du lait ___ du jus d'orange ?",          choices:["ou","où"], answer:"ou"  },
    { type:"choix-etiquette", instruction:"Quel mot complète la phrase : « ou » ou « où » ?", word:"Je ne sais pas ___ j'ai mis mes clés.",           choices:["ou","où"], answer:"où"  },
    { type:"choix-etiquette", instruction:"Quel mot complète la phrase : « ou » ou « où » ?", word:"Il part en vacances en juillet ___ en août.",     choices:["ou","où"], answer:"ou"  },
    { type:"choix-etiquette", instruction:"Quel mot complète la phrase : « ou » ou « où » ?", word:"La ville ___ je suis né est très belle.",         choices:["ou","où"], answer:"où"  },
    { type:"choix-etiquette", instruction:"Quel mot complète la phrase : « ou » ou « où » ?", word:"Tu préfères le foot ___ le tennis ?",             choices:["ou","où"], answer:"ou"  },
    { type:"choix-etiquette", instruction:"Quel mot complète la phrase : « ou » ou « où » ?", word:"C'est la forêt ___ nous nous sommes perdus.",     choices:["ou","où"], answer:"où"  },
    { type:"choix-etiquette", instruction:"Quel mot complète la phrase : « ou » ou « où » ?", word:"Elle viendra demain ___ après-demain.",           choices:["ou","où"], answer:"ou"  },
    { type:"choix-etiquette", instruction:"Quel mot complète la phrase : « ou » ou « où » ?", word:"Le village ___ elle habite est très calme.",      choices:["ou","où"], answer:"où"  },
    { type:"choix-etiquette", instruction:"Quel mot complète la phrase : « ou » ou « où » ?", word:"On peut y aller à pied ___ en vélo.",             choices:["ou","où"], answer:"ou"  },
    { type:"choix-etiquette", instruction:"Quel mot complète la phrase : « ou » ou « où » ?", word:"Je me souviens du jour ___ tu es arrivé.",        choices:["ou","où"], answer:"où"  },
    { type:"choix-etiquette", instruction:"Quel mot complète la phrase : « ou » ou « où » ?", word:"Il peut choisir la mer ___ la montagne.",         choices:["ou","où"], answer:"ou"  },
    { type:"choix-etiquette", instruction:"Quel mot complète la phrase : « ou » ou « où » ?", word:"La montagne ___ nous avons campé était superbe.", choices:["ou","où"], answer:"où"  }
  ],
  ...
  "ortho-distinguer-quel-quelle-quels-quelles": {
    ...
    level1Bank: [
      { type:"choix-etiquette", instruction:"Quelle forme complète la phrase : « quel », « quelle », « quels » ou « quelles » ?", word:"___ livre as-tu choisi ?",          choices:["quel","quelle","quels","quelles"], answer:"quel"    },
      { type:"choix-etiquette", instruction:"Quelle forme complète la phrase : « quel », « quelle », « quels » ou « quelles » ?", word:"___ heure est-il ?",                choices:["quel","quelle","quels","quelles"], answer:"quelle"  },
      { type:"choix-etiquette", instruction:"Quelle forme complète la phrase : « quel », « quelle », « quels » ou « quelles » ?", word:"___ beaux paysages !",              choices:["quel","quelle","quels","quelles"], answer:"quels"   },
      { type:"choix-etiquette", instruction:"Quelle forme complète la phrase : « quel », « quelle », « quels » ou « quelles » ?", word:"___ belles fleurs !",               choices:["quel","quelle","quels","quelles"], answer:"quelles" },
      { type:"choix-etiquette", instruction:"Quelle forme complète la phrase : « quel », « quelle », « quels » ou « quelles » ?", word:"Je ne sais pas ___ chemin prendre.", choices:["quel","quelle","quels","quelles"], answer:"quel"    },
      { type:"choix-etiquette", instruction:"Quelle forme complète la phrase : « quel », « quelle », « quels » ou « quelles » ?", word:"___ chance tu as !",                choices:["quel","quelle","quels","quelles"], answer:"quelle"  },
      { type:"choix-etiquette", instruction:"Quelle forme complète la phrase : « quel », « quelle », « quels » ou « quelles » ?", word:"___ sont tes sports préférés ?",    choices:["quel","quelle","quels","quelles"], answer:"quels"   },
      { type:"choix-etiquette", instruction:"Quelle forme complète la phrase : « quel », « quelle », « quels » ou « quelles » ?", word:"___ sont tes matières préférées ?", choices:["quel","quelle","quels","quelles"], answer:"quelles" },
      { type:"choix-etiquette", instruction:"Quelle forme complète la phrase : « quel », « quelle », « quels » ou « quelles » ?", word:"___ temps fait-il dehors ?",        choices:["quel","quelle","quels","quelles"], answer:"quel"    },
      { type:"choix-etiquette", instruction:"Quelle forme complète la phrase : « quel », « quelle », « quels » ou « quelles » ?", word:"___ surprise !",                    choices:["quel","quelle","quels","quelles"], answer:"quelle"  },
      { type:"choix-etiquette", instruction:"Quelle forme complète la phrase : « quel », « quelle », « quels » ou « quelles » ?", word:"Dis-moi ___ films tu aimes.",       choices:["quel","quelle","quels","quelles"], answer:"quels"   },
      { type:"choix-etiquette", instruction:"Quelle forme complète la phrase : « quel », « quelle », « quels » ou « quelles » ?", word:"Dis-moi ___ chansons tu écoutes.",  choices:["quel","quelle","quels","quelles"], answer:"quelles" }
    ],

    level2Bank: [
      { type:"choix-etiquette", instruction:"Quel mot complète la phrase : « quelle » ou « qu'elle » ?", word:"Je sais ___ a raison.",             choices:["quelle","qu'elle"], answer:"qu'elle" },
      { type:"choix-etiquette", instruction:"Quel mot complète la phrase : « quelle » ou « qu'elle » ?", word:"___ belle journée !",                choices:["quelle","qu'elle"], answer:"quelle"  },
      { type:"choix-etiquette", instruction:"Quel mot complète la phrase : « quelle » ou « qu'elle » ?", word:"Il pense ___ viendra demain.",       choices:["quelle","qu'elle"], answer:"qu'elle" },
      { type:"choix-etiquette", instruction:"Quel mot complète la phrase : « quelle » ou « qu'elle » ?", word:"Je ne sais pas ___ heure il est.",   choices:["quelle","qu'elle"], answer:"quelle"  },
      { type:"choix-etiquette", instruction:"Quel mot complète la phrase : « quelle » ou « qu'elle » ?", word:"Il espère ___ réussira.",            choices:["quelle","qu'elle"], answer:"qu'elle" },
      { type:"choix-etiquette", instruction:"Quel mot complète la phrase : « quelle » ou « qu'elle » ?", word:"___ surprise de la voir ici !",      choices:["quelle","qu'elle"], answer:"quelle"  },
      { type:"choix-etiquette", instruction:"Quel mot complète la phrase : « quelle » ou « qu'elle » ?", word:"Il dit ___ est malade.",             choices:["quelle","qu'elle"], answer:"qu'elle" },
      { type:"choix-etiquette", instruction:"Quel mot complète la phrase : « quelle » ou « qu'elle » ?", word:"___ est cette odeur ?",              choices:["quelle","qu'elle"], answer:"quelle"  },
      { type:"choix-etiquette", instruction:"Quel mot complète la phrase : « quelles » ou « qu'elles » ?", word:"Je crois ___ sont parties.",             choices:["quelles","qu'elles"], answer:"qu'elles" },
      { type:"choix-etiquette", instruction:"Quel mot complète la phrase : « quelles » ou « qu'elles » ?", word:"___ sont tes couleurs préférées ?",      choices:["quelles","qu'elles"], answer:"quelles"  },
      { type:"choix-etiquette", instruction:"Quel mot complète la phrase : « quelles » ou « qu'elles » ?", word:"Il pense ___ ont raison.",               choices:["quelles","qu'elles"], answer:"qu'elles" },
      { type:"choix-etiquette", instruction:"Quel mot complète la phrase : « quelles » ou « qu'elles » ?", word:"___ belles photos elles ont prises !",   choices:["quelles","qu'elles"], answer:"quelles"  }
    ],

    /* Niveau 3 : les six formes mélangées — 12 phrases à 1 blanc
       (choix-etiquette) + 6 phrases à 2 blancs indépendants (double-blanc). */
    level3Bank: [
      { type:"choix-etiquette", instruction:"Quel mot complète la phrase ?", word:"___ film regardes-tu ?",                    choices:["quel","quelle"],       answer:"quel"    },
      { type:"choix-etiquette", instruction:"Quel mot complète la phrase ?", word:"Je crois ___ a compris la leçon.",          choices:["quelle","qu'elle"],    answer:"qu'elle" },
      { type:"choix-etiquette", instruction:"Quel mot complète la phrase ?", word:"___ jolies fleurs tu as cueillies !",       choices:["quelles","qu'elles"],  answer:"quelles" },
      { type:"choix-etiquette", instruction:"Quel mot complète la phrase ?", word:"Il pense ___ sont en retard.",              choices:["quelles","qu'elles"],  answer:"qu'elles" },
      { type:"choix-etiquette", instruction:"Quel mot complète la phrase ?", word:"___ sport pratiques-tu ?",                  choices:["quel","quels"],        answer:"quel"    },
      { type:"choix-etiquette", instruction:"Quel mot complète la phrase ?", word:"___ chance incroyable !",                   choices:["quelle","qu'elle"],    answer:"quelle"  },
      { type:"choix-etiquette", instruction:"Quel mot complète la phrase ?", word:"Dis-moi ___ livres tu préfères.",           choices:["quel","quels"],        answer:"quels"   },
      { type:"choix-etiquette", instruction:"Quel mot complète la phrase ?", word:"Il espère ___ sera là.",                    choices:["quelle","qu'elle"],    answer:"qu'elle" },
      { type:"choix-etiquette", instruction:"Quel mot complète la phrase ?", word:"___ sont les règles du jeu ?",              choices:["quelles","qu'elles"],  answer:"quelles" },
      { type:"choix-etiquette", instruction:"Quel mot complète la phrase ?", word:"Je sais ___ ont tout préparé.",             choices:["quelles","qu'elles"],  answer:"qu'elles" },
      { type:"choix-etiquette", instruction:"Quel mot complète la phrase ?", word:"___ beau tableau !",                        choices:["quel","quelle"],       answer:"quel"    },
      { type:"choix-etiquette", instruction:"Quel mot complète la phrase ?", word:"___ est ton adresse ?",                     choices:["quelle","qu'elle"],    answer:"quelle"  },
...
"ortho-distinguer-son-sont": {
  ...
  level1Bank: [
    { type:"choix-etiquette", instruction:"Quel mot complète la phrase : « son » ou « sont » ?", word:"Les enfants ___ fatigués après la récréation.", choices:["son","sont"], answer:"sont" },
    { type:"choix-etiquette", instruction:"Quel mot complète la phrase : « son » ou « sont » ?", word:"Il a oublié ___ cartable à la maison.",           choices:["son","sont"], answer:"son"  },
    { type:"choix-etiquette", instruction:"Quel mot complète la phrase : « son » ou « sont » ?", word:"Les fleurs ___ écloses ce matin.",              choices:["son","sont"], answer:"sont" },
    { type:"choix-etiquette", instruction:"Quel mot complète la phrase : « son » ou « sont » ?", word:"Elle range ___ manteau dans l'armoire.",        choices:["son","sont"], answer:"son"  },
    { type:"choix-etiquette", instruction:"Quel mot complète la phrase : « son » ou « sont » ?", word:"Les élèves ___ attentifs en classe.",           choices:["son","sont"], answer:"sont" },
    { type:"choix-etiquette", instruction:"Quel mot complète la phrase : « son » ou « sont » ?", word:"Le chien a retrouvé ___ os.",                   choices:["son","sont"], answer:"son"  },
    { type:"choix-etiquette", instruction:"Quel mot complète la phrase : « son » ou « sont » ?", word:"Les nuages ___ très sombres ce soir.",         choices:["son","sont"], answer:"sont" },
    { type:"choix-etiquette", instruction:"Quel mot complète la phrase : « son » ou « sont » ?", word:"Il prête ___ vélo à un ami.",                   choices:["son","sont"], answer:"son"  },
    { type:"choix-etiquette", instruction:"Quel mot complète la phrase : « son » ou « sont » ?", word:"Les résultats ___ excellents cette année.",    choices:["son","sont"], answer:"sont" },
    { type:"choix-etiquette", instruction:"Quel mot complète la phrase : « son » ou « sont » ?", word:"Elle a perdu ___ écharpe rouge.",               choices:["son","sont"], answer:"son"  },
    { type:"choix-etiquette", instruction:"Quel mot complète la phrase : « son » ou « sont » ?", word:"Les portes ___ fermées à clé.",                 choices:["son","sont"], answer:"sont" },
    { type:"choix-etiquette", instruction:"Quel mot complète la phrase : « son » ou « sont » ?", word:"Le chat lèche ___ pelage.",                     choices:["son","sont"], answer:"son"  }
  ],
  ...
  level2Bank: [
    ...
    { type:"mots-cliquables", instruction:"Clique sur le mot mal orthographié s'il y en a un, puis valide. (Si la phrase est correcte, valide directement sans rien sélectionner.)",
      ...
      note:"Teste « mon livre » : ça ne fonctionne pas → on écrit <strong>son</strong>." },
    { type:"mots-cliquables", instruction:"Clique sur le mot mal orthographié s'il y en a un, puis valide. (Si la phrase est correcte, valide directement sans rien sélectionner.)",
    ...
    { type:"mots-cliquables", instruction:"Clique sur le mot mal orthographié s'il y en a un, puis valide. (Si la phrase est correcte, valide directement sans rien sélectionner.)",
      ...
      note:"Teste « mon avis » : ça ne fonctionne pas → on écrit <strong>son</strong>." },
    { type:"mots-cliquables", instruction:"Clique sur le mot mal orthographié s'il y en a un, puis valide. (Si la phrase est correcte, valide directement sans rien sélectionner.)",
    ...
    { type:"mots-cliquables", instruction:"Clique sur le mot mal orthographié s'il y en a un, puis valide. (Si la phrase est correcte, valide directement sans rien sélectionner.)",
      ...
      note:"Teste « mon erreur » : ça ne fonctionne pas → on écrit <strong>son</strong>." },
    { type:"mots-cliquables", instruction:"Clique sur le mot mal orthographié s'il y en a un, puis valide. (Si la phrase est correcte, valide directement sans rien sélectionner.)",
  ...
  level3Bank: [
    ...
    { type:"texte-a-trous", sentence:"Le directeur a exprimé ___ mécontentement.",
      blanks:[{ answer:"son", hint:"« mon mécontentement » ne fonctionne pas → on écrit « son »." }] },
    ...
    { type:"texte-a-trous", sentence:"L'artiste a exposé ___ dernier tableau.",
      blanks:[{ answer:"son", hint:"« mon dernier tableau » ne fonctionne pas → on écrit « son »." }] },
    ...
    { type:"texte-a-trous", sentence:"Le médecin a donné ___ accord pour l'opération.",
      blanks:[{ answer:"son", hint:"« mon accord » ne fonctionne pas → on écrit « son »." }] },
    { type:"texte-a-trous", sentence:"Les élèves ___ studieux et leur professeur est fier de ___ travail.",
      blanks:[{ answer:"sont", hint:"« étaient studieux » fonctionne → on écrit « sont »." },
              { answer:"son",  hint:"« mon travail » ne fonctionne pas → on écrit « son »." }] },
    { type:"texte-a-trous", sentence:"___ discours était long et les spectateurs ___ partis avant la fin.",
      blanks:[{ answer:"son",  hint:"« mon discours » ne fonctionne pas → on écrit « son »." },
    ...
    { type:"texte-a-trous", sentence:"Les résultats ___ bons et le directeur garde ___ calme.",
      blanks:[{ answer:"sont", hint:"« étaient bons » fonctionne → on écrit « sont »." },
              { answer:"son",  hint:"« mon calme » ne fonctionne pas → on écrit « son »." }] },
    { type:"texte-a-trous", sentence:"Il a perdu ___ chemin et ses amis ___ inquiets.",
      blanks:[{ answer:"son",  hint:"« mon chemin » ne fonctionne pas → on écrit « son »." },
    ...
    { type:"texte-a-trous", sentence:"Les arbres ___ hauts et ___ ombre est bienfaisante.",
      blanks:[{ answer:"sont", hint:"« étaient hauts » fonctionne → on écrit « sont »." },
              { answer:"son",  hint:"« mon ombre » ne fonctionne pas → on écrit « son »." }] },
    { type:"texte-a-trous", sentence:"___ équipe a gagné et les supporters ___ en fête.",
      blanks:[{ answer:"son",  hint:"« mon équipe » ne fonctionne pas → on écrit « son »." },
  ...
  "ortho-distinguer-tout-tous-toute-toutes": {
    ...
    level1Bank: [
      { type:"choix-etiquette", instruction:"Quelle forme complète la phrase : « toute » ou « toutes » ?", word:"___ la classe a applaudi.",       choices:["toute","toutes"], answer:"toute"  },
      { type:"choix-etiquette", instruction:"Quelle forme complète la phrase : « toute » ou « toutes » ?", word:"___ les filles ont participé.",  choices:["toute","toutes"], answer:"toutes" },
      { type:"choix-etiquette", instruction:"Quelle forme complète la phrase : « toute » ou « toutes » ?", word:"Elle a mangé ___ la tarte.",     choices:["toute","toutes"], answer:"toute"  },
      { type:"choix-etiquette", instruction:"Quelle forme complète la phrase : « toute » ou « toutes » ?", word:"___ les portes sont fermées.",   choices:["toute","toutes"], answer:"toutes" },
      { type:"choix-etiquette", instruction:"Quelle forme complète la phrase : « toute » ou « toutes » ?", word:"Il a neigé ___ la nuit.",        choices:["toute","toutes"], answer:"toute"  },
      { type:"choix-etiquette", instruction:"Quelle forme complète la phrase : « toute » ou « toutes » ?", word:"___ les équipes sont prêtes.",   choices:["toute","toutes"], answer:"toutes" },
      { type:"choix-etiquette", instruction:"Quelle forme complète la phrase : « toute » ou « toutes » ?", word:"Elle court ___ la journée.",    choices:["toute","toutes"], answer:"toute"  },
      { type:"choix-etiquette", instruction:"Quelle forme complète la phrase : « toute » ou « toutes » ?", word:"___ les maisons sont illuminées.", choices:["toute","toutes"], answer:"toutes" },
      { type:"choix-etiquette", instruction:"Quelle forme complète la phrase : « toute » ou « toutes » ?", word:"___ la ville est en fête.",      choices:["toute","toutes"], answer:"toute"  },
      { type:"choix-etiquette", instruction:"Quelle forme complète la phrase : « toute » ou « toutes » ?", word:"___ les routes sont barrées.",   choices:["toute","toutes"], answer:"toutes" },
      { type:"choix-etiquette", instruction:"Quelle forme complète la phrase : « toute » ou « toutes » ?", word:"Il a attendu ___ la matinée.",  choices:["toute","toutes"], answer:"toute"  },
      { type:"choix-etiquette", instruction:"Quelle forme complète la phrase : « toute » ou « toutes » ?", word:"___ les fenêtres sont ouvertes.", choices:["toute","toutes"], answer:"toutes" }
    ],

    level2Bank: [
      { type:"choix-etiquette", instruction:"Quelle forme complète la phrase : « tout » ou « tous » ?", word:"___ les garçons sont présents.",           choices:["tout","tous"], answer:"tous" },
      { type:"choix-etiquette", instruction:"Quelle forme complète la phrase : « tout » ou « tous » ?", word:"Il a lu ___ le livre en une nuit.",        choices:["tout","tous"], answer:"tout" },
      { type:"choix-etiquette", instruction:"Quelle forme complète la phrase : « tout » ou « tous » ?", word:"___ les jours il se lève tôt.",            choices:["tout","tous"], answer:"tous" },
      { type:"choix-etiquette", instruction:"Quelle forme complète la phrase : « tout » ou « tous » ?", word:"Il a mangé ___ le gâteau.",                choices:["tout","tous"], answer:"tout" },
      { type:"choix-etiquette", instruction:"Quelle forme complète la phrase : « tout » ou « tous » ?", word:"___ les élèves ont réussi.",               choices:["tout","tous"], answer:"tous" },
      { type:"choix-etiquette", instruction:"Quelle forme complète la phrase : « tout » ou « tous » ?", word:"C'est ___ ce que je sais.",                choices:["tout","tous"], answer:"tout" },
      { type:"choix-etiquette", instruction:"Quelle forme complète la phrase : « tout » ou « tous » ?", word:"___ le monde était là.",                   choices:["tout","tous"], answer:"tout" },
      { type:"choix-etiquette", instruction:"Quelle forme complète la phrase : « tout » ou « tous » ?", word:"Ils sont ___ partis à midi.",              choices:["tout","tous"], answer:"tous" },
      { type:"choix-etiquette", instruction:"Quelle forme complète la phrase : « tout » ou « tous » ?", word:"___ le temps il pleut ici.",               choices:["tout","tous"], answer:"tout" },
      { type:"choix-etiquette", instruction:"Quelle forme complète la phrase : « tout » ou « tous » ?", word:"Il a ___ compris.",                        choices:["tout","tous"], answer:"tout" },
      { type:"choix-etiquette", instruction:"Quelle forme complète la phrase : « tout » ou « tous » ?", word:"___ les arbres ont perdu leurs feuilles.", choices:["tout","tous"], answer:"tous" },
      { type:"choix-etiquette", instruction:"Quelle forme complète la phrase : « tout » ou « tous » ?", word:"C'est ___ pour aujourd'hui.",              choices:["tout","tous"], answer:"tout" }
    ],

    /* Niveau 3 : 16 phrases à 1 blanc (choix parmi les 4 formes) + 6 phrases
       à 2 blancs indépendants (double-blanc), mélangées ensemble. */
    level3Bank: [
      { type:"choix-etiquette", instruction:"Quelle forme complète la phrase : « tout », « tous », « toute » ou « toutes » ?", word:"___ la nuit il a pleuré.",                 choices:["tout","tous","toute","toutes"], answer:"toute"  },
      { type:"choix-etiquette", instruction:"Quelle forme complète la phrase : « tout », « tous », « toute » ou « toutes » ?", word:"___ les enfants adorent les histoires.",   choices:["tout","tous","toute","toutes"], answer:"tous"   },
      { type:"choix-etiquette", instruction:"Quelle forme complète la phrase : « tout », « tous », « toute » ou « toutes » ?", word:"Elle est ___ contente de son résultat.",   choices:["tout","tous","toute","toutes"], answer:"toute"  },
      { type:"choix-etiquette", instruction:"Quelle forme complète la phrase : « tout », « tous », « toute » ou « toutes » ?", word:"___ le village était réveillé.",           choices:["tout","tous","toute","toutes"], answer:"tout"   },
      { type:"choix-etiquette", instruction:"Quelle forme complète la phrase : « tout », « tous », « toute » ou « toutes » ?", word:"___ les fleurs ont fané.",                 choices:["tout","tous","toute","toutes"], answer:"toutes" },
      { type:"choix-etiquette", instruction:"Quelle forme complète la phrase : « tout », « tous », « toute » ou « toutes » ?", word:"Il est ___ petit encore.",                 choices:["tout","tous","toute","toutes"], answer:"tout"   },
      { type:"choix-etiquette", instruction:"Quelle forme complète la phrase : « tout », « tous », « toute » ou « toutes » ?", word:"___ les nuits sont calmes ici.",           choices:["tout","tous","toute","toutes"], answer:"toutes" },
      { type:"choix-etiquette", instruction:"Quelle forme complète la phrase : « tout », « tous », « toute » ou « toutes » ?", word:"Il a couru ___ le trajet.",                choices:["tout","tous","toute","toutes"], answer:"tout"   },
      { type:"choix-etiquette", instruction:"Quelle forme complète la phrase : « tout », « tous », « toute » ou « toutes » ?", word:"Elles sont ___ arrivées en retard.",       choices:["tout","tous","toute","toutes"], answer:"toutes" },
      { type:"choix-etiquette", instruction:"Quelle forme complète la phrase : « tout », « tous », « toute » ou « toutes » ?", word:"___ la semaine il fait beau.",             choices:["tout","tous","toute","toutes"], answer:"toute"  },
      { type:"choix-etiquette", instruction:"Quelle forme complète la phrase : « tout », « tous », « toute » ou « toutes » ?", word:"Ils sont ___ fatigués.",                   choices:["tout","tous","toute","toutes"], answer:"tous"   },
      { type:"choix-etiquette", instruction:"Quelle forme complète la phrase : « tout », « tous », « toute » ou « toutes » ?", word:"___ le monde était là.",                   choices:["tout","tous","toute","toutes"], answer:"tout"   },
      { type:"choix-etiquette", instruction:"Quelle forme complète la phrase : « tout », « tous », « toute » ou « toutes » ?", word:"___ les équipes étaient là.",              choices:["tout","tous","toute","toutes"], answer:"toutes" },
      { type:"choix-etiquette", instruction:"Quelle forme complète la phrase : « tout », « tous », « toute » ou « toutes » ?", word:"Elle était ___ rouge de honte.",           choices:["tout","tous","toute","toutes"], answer:"toute"  },
      { type:"choix-etiquette", instruction:"Quelle forme complète la phrase : « tout », « tous », « toute » ou « toutes » ?", word:"___ les matins il prend son café.",        choices:["tout","tous","toute","toutes"], answer:"tous"   },
      { type:"choix-etiquette", instruction:"Quelle forme complète la phrase : « tout », « tous », « toute » ou « toutes » ?", word:"C'est ___ ce qu'il restait.",              choices:["tout","tous","toute","toutes"], answer:"tout"   },
