...
Object.assign(window.EXERCISE_DATA, {
  ...
  "distinguer-attribut-sujet-complement-objet": {
    ...
    level1Bank: [
      { type:"choix-etiquette", instruction:"Ce verbe est-il un verbe d'état ou un verbe d'action ?",
  ...
  "identifier-adverbe": {
    ...
    level1Bank: [
      { type:"choix-etiquette", instruction:"Clique sur l'adverbe parmi ces mots.",
  ...
  "identifier-groupe-sujet": {
    ...
    level1Bank: [
      { type:"mots-cliquables", instruction:"Clique sur le(s) mot(s) qui forment le groupe sujet.",
  ...
  "identifier-preposition": {
    ...
    level3Bank: [
      { type:"mots-cliquables", instruction:"Clique sur toutes les prépositions de la phrase.",
  ...
  "distinguer-cod-coi": {
    ...
    level1Bank: [
      { type:"mots-cliquables", instruction:"Clique sur le complément d'objet dans chaque phrase.",
