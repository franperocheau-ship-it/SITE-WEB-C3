...
Object.assign(window.EXERCISE_DATA, {
  ...
  "ortho-accorder-participe-passe-cod": {
    ...
    ─────────────────────────────────────────────────────────────────── */
    level1Bank: [
      { id:"ortho-accorder-participe-passe-cod-n1-01", codWords: ["Les", "photos"],  codCore: "photos",  codPhrase: "les photos",
        gender: "f", number: "p", base: "pris", infinitive: "prendre",
        sentence: "Les photos que j'ai ___ sont magnifiques.", answer: "prises" },
      { id:"ortho-accorder-participe-passe-cod-n1-02", codWords: ["La", "lettre"],   codCore: "lettre",  codPhrase: "la lettre",
        gender: "f", number: "s", base: "écrit", infinitive: "écrire",
        sentence: "La lettre qu'il a ___ était très longue.", answer: "écrite" },
      { id:"ortho-accorder-participe-passe-cod-n1-03", codWords: ["Les", "livres"],  codCore: "livres",  codPhrase: "les livres",
        gender: "m", number: "p", base: "lu", infinitive: "lire",
        sentence: "Les livres que nous avons ___ étaient passionnants.", answer: "lus" },
      { id:"ortho-accorder-participe-passe-cod-n1-04", codWords: ["La", "tarte"],    codCore: "tarte",   codPhrase: "la tarte",
        gender: "f", number: "s", base: "fait", infinitive: "faire",
        sentence: "La tarte que ma mère a ___ est délicieuse.", answer: "faite" },
      { id:"ortho-accorder-participe-passe-cod-n1-05", codWords: ["Les", "chansons"], codCore: "chansons", codPhrase: "les chansons",
        gender: "f", number: "p", base: "chanté", infinitive: "chanter",
        sentence: "Les chansons qu'elles ont ___ étaient belles.", answer: "chantées" },
      { id:"ortho-accorder-participe-passe-cod-n1-06", codWords: ["La", "robe"],     codCore: "robe",    codPhrase: "la robe",
        gender: "f", number: "s", base: "choisi", infinitive: "choisir",
        sentence: "La robe que Julie a ___ est magnifique.", answer: "choisie" },
      { id:"ortho-accorder-participe-passe-cod-n1-07", codWords: ["Les", "devoirs"], codCore: "devoirs", codPhrase: "les devoirs",
      ...
      { id:"ortho-accorder-participe-passe-cod-n1-08", codWords: ["La", "voiture"],  codCore: "voiture", codPhrase: "la voiture",
        gender: "f", number: "s", base: "acheté", infinitive: "acheter",
        sentence: "La voiture que mon père a ___ est rouge.", answer: "achetée" },
      { id:"ortho-accorder-participe-passe-cod-n1-09", codWords: ["Les", "fleurs"],  codCore: "fleurs",  codPhrase: "les fleurs",
        gender: "f", number: "p", base: "cueilli", infinitive: "cueillir",
        sentence: "Les fleurs que tu as ___ sentent bon.", answer: "cueillies" },
      { id:"ortho-accorder-participe-passe-cod-n1-10", codWords: ["La", "leçon"],    codCore: "leçon",   codPhrase: "la leçon",
    ...
    ─────────────────────────────────────────────────────────────────── */
    level2Bank: [
      { id:"ortho-accorder-participe-passe-cod-n2-01", base: "regardé",  infinitive: "regarder", sentence: "Cette émission, je l'ai ___ deux fois.",
        answer: "regardée", explanation: "Le COD « cette émission », repris par « l' », est féminin singulier → « regardée »." },
      { id:"ortho-accorder-participe-passe-cod-n2-02", base: "préparé",  infinitive: "préparer", sentence: "Ces gâteaux, maman les a ___ ce matin.",
        answer: "préparés", explanation: "Le COD « ces gâteaux », repris par « les », est masculin pluriel → « préparés »." },
      { id:"ortho-accorder-participe-passe-cod-n2-03", base: "mis",      infinitive: "mettre", sentence: "Mes clés, je les ai ___ dans mon sac.",
        answer: "mises", explanation: "Le COD « mes clés », repris par « les », est féminin pluriel → « mises »." },
      { id:"ortho-accorder-participe-passe-cod-n2-04", base: "lu",       infinitive: "lire", sentence: "Ce livre, je l'ai ___ deux fois.",
        answer: "lu", explanation: "Le COD « ce livre », repris par « l' », est masculin singulier → « lu » (pas de terminaison supplémentaire)." },
      { id:"ortho-accorder-participe-passe-cod-n2-05", base: "acheté",   infinitive: "acheter", sentence: "Cette maison, mes parents l'ont ___ l'an dernier.",
        answer: "achetée", explanation: "Le COD « cette maison », repris par « l' », est féminin singulier → « achetée »." },
      { id:"ortho-accorder-participe-passe-cod-n2-06", base: "pris",     infinitive: "prendre", sentence: "Ces photos, je les ai ___ pendant les vacances.",
        answer: "prises", explanation: "Le COD « ces photos », repris par « les », est féminin pluriel → « prises »." },
      { id:"ortho-accorder-participe-passe-cod-n2-07", base: "mangé",    infinitive: "manger", sentence: "Ce gâteau, je l'ai ___ hier soir.",
        answer: "mangé", explanation: "Le COD « ce gâteau », repris par « l' », est masculin singulier → « mangé » (pas de terminaison supplémentaire)." },
      { id:"ortho-accorder-participe-passe-cod-n2-08", base: "raconté",  infinitive: "raconter", sentence: "Cette histoire, il l'a ___ en classe.",
        answer: "racontée", explanation: "Le COD « cette histoire », repris par « l' », est féminin singulier → « racontée »." },
      { id:"ortho-accorder-participe-passe-cod-n2-09", base: "rendu",    infinitive: "rendre", sentence: "Ces devoirs, les élèves les ont ___ à temps.",
        answer: "rendus", explanation: "Le COD « ces devoirs », repris par « les », est masculin pluriel → « rendus »." },
      { id:"ortho-accorder-participe-passe-cod-n2-10", base: "envoyé",   infinitive: "envoyer", sentence: "Ce message, je l'ai ___ ce matin.",
    ...
    level3Bank: [
      /* ── Accord : COD antéposé ── */
      { id:"ortho-accorder-participe-passe-cod-n3-01", base: "visité",  infinitive: "visiter", hasCodBefore: true,
      ...
      { id:"ortho-accorder-participe-passe-cod-n3-02", base: "envoyé",  infinitive: "envoyer", hasCodBefore: true,
      ...
      { id:"ortho-accorder-participe-passe-cod-n3-03", base: "rangé",   infinitive: "ranger", hasCodBefore: true,
      ...
      { id:"ortho-accorder-participe-passe-cod-n3-04", base: "cueilli", infinitive: "cueillir", hasCodBefore: true,
      ...
      { id:"ortho-accorder-participe-passe-cod-n3-05", base: "écrit",   infinitive: "écrire", hasCodBefore: true,
      ...
      { id:"ortho-accorder-participe-passe-cod-n3-06", base: "cueilli", infinitive: "cueillir", hasCodBefore: false,
      ...
      { id:"ortho-accorder-participe-passe-cod-n3-07", base: "visité",  infinitive: "visiter", hasCodBefore: false,
      ...
      { id:"ortho-accorder-participe-passe-cod-n3-08", base: "envoyé",  infinitive: "envoyer", hasCodBefore: false,
      ...
      { id:"ortho-accorder-participe-passe-cod-n3-09", base: "rangé",   infinitive: "ranger", hasCodBefore: false,
      ...
      { id:"ortho-accorder-participe-passe-cod-n3-10", base: "ri",     infinitive: "rire", hasCodBefore: false,
        sentence: "Nous avons ___ toute la journée.", answer: "ri",
        explanation: "Il n'y a pas de COD → le participe passé ne s'accorde pas : « ri »." },
      { id:"ortho-accorder-participe-passe-cod-n3-11", base: "dormi",  infinitive: "dormir", hasCodBefore: false,
      ...
      { id:"ortho-accorder-participe-passe-cod-n3-12", base: "couru",  infinitive: "courir", hasCodBefore: false,
  ...
  "ortho-accorder-participe-passe-etre": {
    ...
    ─────────────────────────────────────────────────────────────────── */
    level1Bank: [
      { id:"ortho-accorder-participe-passe-etre-n1-01", subjectWords: ["elle"],        subjectCore: "elle",   subjectPhrase: "elle",        gender: "f", number: "s",
        infinitive: "aller",   sentence: "Hier, elle ________ au parc.",        answer: "est allée" },
      { id:"ortho-accorder-participe-passe-etre-n1-02", subjectWords: ["Ils"],         subjectCore: "Ils",    subjectPhrase: "ils",         gender: "m", number: "p",
        infinitive: "partir",  sentence: "Ils ________ sans prévenir.",         answer: "sont partis" },
      { id:"ortho-accorder-participe-passe-etre-n1-03", subjectWords: ["Il"],          subjectCore: "Il",     subjectPhrase: "il",          gender: "m", number: "s",
        infinitive: "tomber",  sentence: "Il ________ dans la cour.",           answer: "est tombé" },
      { id:"ortho-accorder-participe-passe-etre-n1-04", subjectWords: ["Elles"],       subjectCore: "Elles",  subjectPhrase: "elles",       gender: "f", number: "p",
        infinitive: "venir",   sentence: "Elles ________ nous voir.",           answer: "sont venues" },
      { id:"ortho-accorder-participe-passe-etre-n1-05", subjectWords: ["Vous"],        subjectCore: "Vous",   subjectPhrase: "vous",        gender: "m", number: "p",
        infinitive: "monter",  sentence: "Vous ________ trop vite.",            answer: "êtes montés" },
      { id:"ortho-accorder-participe-passe-etre-n1-06", subjectWords: ["Ma", "sœur"],  subjectCore: "sœur",   subjectPhrase: "ma sœur",     gender: "f", number: "s",
        infinitive: "naître",  sentence: "Ma sœur ________ en décembre.",       answer: "est née" },
      { id:"ortho-accorder-participe-passe-etre-n1-07", subjectWords: ["Mon", "frère"], subjectCore: "frère", subjectPhrase: "mon frère",  gender: "m", number: "s",
        infinitive: "revenir", sentence: "Mon frère ________ de voyage.",       answer: "est revenu" },
      { id:"ortho-accorder-participe-passe-etre-n1-08", subjectWords: ["La", "chatte"], subjectCore: "chatte", subjectPhrase: "la chatte",  gender: "f", number: "s",
        infinitive: "rester",  sentence: "La chatte ________ dehors.",          answer: "est restée" },
      { id:"ortho-accorder-participe-passe-etre-n1-09", subjectWords: ["Les", "filles"], subjectCore: "filles", subjectPhrase: "les filles", gender: "f", number: "p",
        infinitive: "rentrer", sentence: "Les filles ________ à midi.",        answer: "sont rentrées" },
      { id:"ortho-accorder-participe-passe-etre-n1-10", subjectWords: ["Les", "élèves"], subjectCore: "élèves", subjectPhrase: "les élèves", gender: "m", number: "p",
    ...
    level2Bank: [
      { id:"ortho-accorder-participe-passe-etre-n2-01", infinitive: "arriver",  sentence: "Les voisines ________ ensemble.",        answer: "sont arrivées" },
      { id:"ortho-accorder-participe-passe-etre-n2-02", infinitive: "descendre", sentence: "La touriste ________ à Paris.",         answer: "est descendue" },
      { id:"ortho-accorder-participe-passe-etre-n2-03", infinitive: "entrer",   sentence: "La directrice ________ dans la classe.", answer: "est entrée" },
      { id:"ortho-accorder-participe-passe-etre-n2-04", infinitive: "partir",   sentence: "Mes parents ________ en vacances.",      answer: "sont partis" },
      { id:"ortho-accorder-participe-passe-etre-n2-05", infinitive: "partir",   sentence: "Elle ________ tôt ce matin.",            answer: "est partie" },
      { id:"ortho-accorder-participe-passe-etre-n2-06", infinitive: "arriver",  sentence: "Nous ________ en retard.",               answer: "sommes arrivés" },
      { id:"ortho-accorder-participe-passe-etre-n2-07", infinitive: "sortir",   sentence: "Le chien ________ dans le jardin.",      answer: "est sorti" },
      { id:"ortho-accorder-participe-passe-etre-n2-08", infinitive: "monter",   sentence: "Les enfants ________ dans le bus.",      answer: "sont montés" },
      { id:"ortho-accorder-participe-passe-etre-n2-09", infinitive: "rester",   sentence: "On ________ à la maison.",              answer: "est resté" },
      { id:"ortho-accorder-participe-passe-etre-n2-10", infinitive: "venir",    sentence: "La maîtresse ________ nous voir hier.",  answer: "est venue" }
    ],
    ...
    ─────────────────────────────────────────────────────────────────── */
    level3Bank: [
      { id:"ortho-accorder-participe-passe-etre-n3-01", infinitive: "arriver",   sentence: "Le facteur ________ très tôt ce matin.",              answer: "est arrivé" },
      { id:"ortho-accorder-participe-passe-etre-n3-02", infinitive: "rentrer",   sentence: "La voisine ________ tard hier soir.",                 answer: "est rentrée" },
      { id:"ortho-accorder-participe-passe-etre-n3-03", infinitive: "partir",    sentence: "Les chevaliers ________ au combat à l'aube.",          answer: "sont partis" },
      { id:"ortho-accorder-participe-passe-etre-n3-04", infinitive: "naître",    sentence: "Les jumelles ________ le même jour.",                  answer: "sont nées" },
      { id:"ortho-accorder-participe-passe-etre-n3-05", infinitive: "aller",     sentence: "Mon frère et ma sœur ________ chez leurs grands-parents.", answer: "sont allés" },
      { id:"ortho-accorder-participe-passe-etre-n3-06", infinitive: "tomber",    sentence: "Le vieux chêne ________ pendant la tempête.",          answer: "est tombé" },
      { id:"ortho-accorder-participe-passe-etre-n3-07", infinitive: "venir",     sentence: "Ma tante ________ nous rendre visite dimanche.",       answer: "est venue" },
      { id:"ortho-accorder-participe-passe-etre-n3-08", infinitive: "monter",    sentence: "Les explorateurs ________ au sommet de la montagne.",  answer: "sont montés" },
      { id:"ortho-accorder-participe-passe-etre-n3-09", infinitive: "retourner", sentence: "Les championnes ________ sur le podium.",               answer: "sont retournées" },
      { id:"ortho-accorder-participe-passe-etre-n3-10", infinitive: "entrer",    sentence: "Le roi et la reine ________ dans la salle du trône.",  answer: "sont entrés" },
      { id:"ortho-accorder-participe-passe-etre-n3-11", infinitive: "rester",    sentence: "Ma grand-mère ________ à la maison ce week-end.",      answer: "est restée" },
      { id:"ortho-accorder-participe-passe-etre-n3-12", infinitive: "devenir",   sentence: "Les acteurs ________ célèbres du jour au lendemain.",  answer: "sont devenus" }
    ]
  },
