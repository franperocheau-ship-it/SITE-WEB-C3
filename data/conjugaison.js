...
Object.assign(window.EXERCISE_DATA, {
  ...
  "retrouver-infinitif-verbe-conjugue": {
    ...
    bank: [
      ...
      { id: "retrouver-infinitif-verbe-conjugue-n1-01", level: 1, sentence: "Nous mangeons.",      verb: "mangeons",      infinitive: "manger",   group: "1er groupe", choices: ["manger", "mangé", "mangeant", "mangions"] },
      { id: "retrouver-infinitif-verbe-conjugue-n1-02", level: 1, sentence: "Il chantait.",        verb: "chantait",      infinitive: "chanter",  group: "1er groupe", choices: ["chanter", "chanté", "chantant", "chantons"] },
      { id: "retrouver-infinitif-verbe-conjugue-n1-03", level: 1, sentence: "Nous donnons.",       verb: "donnons",       infinitive: "donner",   group: "1er groupe", choices: ["donner", "donné", "donnant", "donnons"] },
      { id: "retrouver-infinitif-verbe-conjugue-n1-04", level: 1, sentence: "Ils finissaient.",    verb: "finissaient",   infinitive: "finir",    group: "2e groupe",  choices: ["finir", "fini", "finissant", "finissait"] },
      { id: "retrouver-infinitif-verbe-conjugue-n1-05", level: 1, sentence: "Nous choisissons.",   verb: "choisissons",   infinitive: "choisir",  group: "2e groupe",  choices: ["choisir", "choisi", "choisissant", "choisissait"] },
      { id: "retrouver-infinitif-verbe-conjugue-n1-06", level: 1, sentence: "Vous obéissez.",      verb: "obéissez",      infinitive: "obéir",    group: "2e groupe",  choices: ["obéir", "obéi", "obéissant", "obéissait"] },
      { id: "retrouver-infinitif-verbe-conjugue-n1-07", level: 1, sentence: "Je vendais.",         verb: "vendais",       infinitive: "vendre",   group: "3e groupe",  choices: ["vendre", "vendu", "vendant", "vendit"] },
      { id: "retrouver-infinitif-verbe-conjugue-n1-08", level: 1, sentence: "Nous entendions.",    verb: "entendions",    infinitive: "entendre", group: "3e groupe",  choices: ["entendre", "entendu", "entendant", "entendait"] },
      { id: "retrouver-infinitif-verbe-conjugue-n1-09", level: 1, sentence: "Ils dormaient.",      verb: "dormaient",     infinitive: "dormir",   group: "3e groupe",  choices: ["dormir", "dormi", "dormant", "dormait"] },
      { id: "retrouver-infinitif-verbe-conjugue-n1-10", level: 1, sentence: "Elle servait.",       verb: "servait",       infinitive: "servir",   group: "3e groupe",  choices: ["servir", "servi", "servant", "servait"] },

      /* ── NIVEAU 2 : saisie de l'infinitif (10) — formes éloignées, subjonctif, passé simple ── */
      { id: "retrouver-infinitif-verbe-conjugue-n2-01", level: 2, sentence: "Ils prennent.",           verb: "prennent",     infinitive: "prendre",  group: "3e groupe" },
      { id: "retrouver-infinitif-verbe-conjugue-n2-02", level: 2, sentence: "Je voyais.",               verb: "voyais",       infinitive: "voir",     group: "3e groupe" },
      { id: "retrouver-infinitif-verbe-conjugue-n2-03", level: 2, sentence: "Ils diront.",               verb: "diront",       infinitive: "dire",     group: "3e groupe" },
      { id: "retrouver-infinitif-verbe-conjugue-n2-04", level: 2, sentence: "Elle écrira.",             verb: "écrira",       infinitive: "écrire",   group: "3e groupe" },
      { id: "retrouver-infinitif-verbe-conjugue-n2-05", level: 2, sentence: "Je lisais.",               verb: "lisais",       infinitive: "lire",     group: "3e groupe" },
      { id: "retrouver-infinitif-verbe-conjugue-n2-06", level: 2, sentence: "Ils couraient.",           verb: "couraient",    infinitive: "courir",   group: "3e groupe" },
      { id: "retrouver-infinitif-verbe-conjugue-n2-07", level: 2, sentence: "Elle réfléchissait.",      verb: "réfléchissait", infinitive: "réfléchir", group: "2e groupe" },
      { id: "retrouver-infinitif-verbe-conjugue-n2-08", level: 2, sentence: "Il faut qu'elle parte.",   verb: "parte",        infinitive: "partir",   group: "3e groupe" },
      { id: "retrouver-infinitif-verbe-conjugue-n2-09", level: 2, sentence: "Ils eurent très peur.",    verb: "eurent",       infinitive: "avoir",    group: "3e groupe" },
      { id: "retrouver-infinitif-verbe-conjugue-n2-10", level: 2, sentence: "Nous fûmes surpris.",      verb: "fûmes",        infinitive: "être",     group: "3e groupe" },

      /* ── NIVEAU 3 : saisie de l'infinitif (10) — pièges classiques ── */
      { id: "retrouver-infinitif-verbe-conjugue-n3-01", level: 3, sentence: "Nous allons au marché.",       verb: "allons",  infinitive: "aller",    group: "3e groupe" },
      { id: "retrouver-infinitif-verbe-conjugue-n3-02", level: 3, sentence: "Ils iront demain.",             verb: "iront",   infinitive: "aller",    group: "3e groupe" },
      { id: "retrouver-infinitif-verbe-conjugue-n3-03", level: 3, sentence: "Va chercher ton frère !",       verb: "va",      infinitive: "aller",    group: "3e groupe" },
      { id: "retrouver-infinitif-verbe-conjugue-n3-04", level: 3, sentence: "Il mourra bientôt.",            verb: "mourra",  infinitive: "mourir",   group: "3e groupe" },
      { id: "retrouver-infinitif-verbe-conjugue-n3-05", level: 3, sentence: "Le champignon croît vite.",     verb: "croît",   infinitive: "croître",  group: "3e groupe" },
      { id: "retrouver-infinitif-verbe-conjugue-n3-06", level: 3, sentence: "Il croit au père Noël.",        verb: "croit",   infinitive: "croire",   group: "3e groupe" },
      { id: "retrouver-infinitif-verbe-conjugue-n3-07", level: 3, sentence: "Ils sortaient tous les soirs.", verb: "sortaient", infinitive: "sortir",  group: "3e groupe" },
      { id: "retrouver-infinitif-verbe-conjugue-n3-08", level: 3, sentence: "Elle servait à table.",         verb: "servait", infinitive: "servir",   group: "3e groupe" },
      { id: "retrouver-infinitif-verbe-conjugue-n3-09", level: 3, sentence: "Elle rougira de honte.",        verb: "rougira", infinitive: "rougir",   group: "2e groupe" },
      { id: "retrouver-infinitif-verbe-conjugue-n3-10", level: 3, sentence: "Il punissait sans pitié.",      verb: "punissait", infinitive: "punir",  group: "2e groupe" }
    ]
  },
