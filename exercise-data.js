...
,
  ...
  /* ══════════════════════════════════════════════════════════════════════
     PROBABILITÉS — Lots 2-3-4 : structure définitive (3 niveaux, 6 exercices
     par compétence, cf. spec §3), énoncés PROVISOIRES (pas encore polis,
     illustrations en emoji simple plutôt qu'en SVG dédié — voir spec §4,
     à faire dans un lot de polish séparé). Chaque `level` (niveau1/2/3) est
     un id interne au moteur — voir LEVEL_LABELS dans exercise.html — sans
     rapport avec la pastille CM1/CM2/6e affichée sur la page de catégorie
     (gérée séparément, mathématiques-probabilites.html — Lot 5).
  ══════════════════════════════════════════════════════════════════════ */
