...
var gc_functions = {
    ...
    _g_cond_gv1_260: function (lToken, nTokenOffset, nLastToken, sCountry, bCondMemo, dTags, sSentence, sSentence0) {
        return g_morph(lToken[nTokenOffset+2], ":[NA].*:[fe]", ">(?:fois|impression)/") && ! g_morph(lToken[nLastToken+1], ":(?:Y|Ov|D|M|LV|ÉV)|>qu[e’]/") && ! ((g_value(lToken[nLastToken-1+1], "|commencé|décidé|essayé|fini|imaginé|ordonné|oublié|recommencé|supplié|tenté|cru|") && g_value(lToken[nLastToken+1], "|de|d’|")) || (g_value(lToken[nLastToken-1+1], "|commencé|recommencé|réussi|pensé|échoué|") && g_value(lToken[nLastToken+1], "|à|")));
    },
    ...
    _g_cond_gv1_269: function (lToken, nTokenOffset, nLastToken, sCountry, bCondMemo, dTags, sSentence, sSentence0) {
        return ! g_morph(lToken[nLastToken+1], ":(?:Y|Ov|D|M|LV|ÉV)") && ! ((g_value(lToken[nLastToken-1+1], "|commencé|demandé|décidé|essayé|exigé|fini|imaginé|ordonné|oublié|recommencé|supplié|tenté|cru|") && g_value(lToken[nLastToken+1], "|de|d’|")) || (g_value(lToken[nLastToken-1+1], "|commencé|recommencé|réussi|pensé|échoué|") && g_value(lToken[nLastToken+1], "|à|"))) && g_morph(lToken[nTokenOffset+2], ":[NA].*:[pi]");
    },
    ...
    _g_cond_gv1_273: function (lToken, nTokenOffset, nLastToken, sCountry, bCondMemo, dTags, sSentence, sSentence0) {
        return ! g_morph(lToken[nLastToken+1], ":(?:Y|Ov|D|M|LV|ÉV)") && ! ((g_value(lToken[nLastToken-1+1], "|commencé|décidé|essayé|fini|imaginé|ordonné|oublié|recommencé|supplié|tenté|cru|") && g_value(lToken[nLastToken+1], "|de|d’|")) || (g_value(lToken[nLastToken-1+1], "|commencé|recommencé|réussi|pensé|échoué|") && g_value(lToken[nLastToken+1], "|à|"))) && g_morph(lToken[nTokenOffset+2], ":[NA].*:[me]:[pi]");
    },
    ...
    _g_cond_gv1_278: function (lToken, nTokenOffset, nLastToken, sCountry, bCondMemo, dTags, sSentence, sSentence0) {
        return ! g_morph(lToken[nLastToken+1], ":(?:Y|Ov|D|LV|ÉV)") && ! ((g_value(lToken[nLastToken-1+1], "|commencé|décidé|essayé|fini|imaginé|ordonné|oublié|recommencé|supplié|tenté|cru|") && g_value(lToken[nLastToken+1], "|de|d’|")) || (g_value(lToken[nLastToken-1+1], "|commencé|recommencé|réussi|pensé|échoué|") && g_value(lToken[nLastToken+1], "|à|")));
    },
    ...
    _g_cond_gv1_311: function (lToken, nTokenOffset, nLastToken, sCountry, bCondMemo, dTags, sSentence, sSentence0) {
        return ! g_tagbefore(lToken[nTokenOffset+2], dTags, "_CUT_") && ! g_value(lToken[nLastToken+1], "|il|elle|on|") && ! ( g_value(lToken[nLastToken-1+1], "|répond|") && (g_morph(lToken[nLastToken+1], ":[MD]|>[A-Z]/") || g_value(lToken[nLastToken+1], "|l’|d’|")) ) && g_morph(lToken[nLastToken-1+1], ":V3.*:Ip.*:3s", ":G");
    },
    _g_cond_gv1_312: function (lToken, nTokenOffset, nLastToken, sCountry, bCondMemo, dTags, sSentence, sSentence0) {
        return ! g_tagbefore(lToken[nTokenOffset+2], dTags, "_CUT_") && ! g_value(lToken[nLastToken+1], "|il|elle|on|") && ! ( g_value(lToken[nLastToken-1+1], "|répond|") && (g_morph(lToken[nLastToken+1], ":[MD]|>[A-Z]/") || g_value(lToken[nLastToken+1], "|l’|d’|")) ) && g_morph(lToken[nLastToken-1+1], ":V3.*:Ip.*:3s", ":[GNA]");
    },
